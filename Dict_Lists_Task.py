...
fruits = ["apple", "banana", "cherry", "orange", "cranberry", "mango"]
print(fruits)
# ---
...
# ---
if "cherry" in newfruits:
    print ("Yes, we have Cherries!")
else:
    print ("There are no Cherries!")
